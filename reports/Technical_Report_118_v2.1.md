...
- **Hidden size:** 128
- **Attention heads:** 2
- **Vocabulary size:** 256 (reduced from 50257)
- **Context length:** Variable (< 1024)

**Parameter Count:** 102,714 (0.103M)
- **Note:** This is an untrained test fixture model. Perplexity values (~50,286) reflect near-uniform distribution over vocabulary.
...
- Amortization: Break-even after ~10M tokens (GPT-2 typical deployment)

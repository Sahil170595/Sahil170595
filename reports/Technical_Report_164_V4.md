...
- Third bandwidth point (§12.3) — grid `research/tr164/modal_amortization_sweep.py --mode bw3` (H200, 84 fp16/d64 cells), analysis `research/tr164/analyze_bw3_slope.py` → `research/tr164/bw3_slope_stats.json`; results `research/tr164/results/modal_amortization/bw3_bw3a/results.json`. Figure generator `papers/serving_stack_physics/v2_boundary/make_bw3_slope_figure.py`.
...
Six figures in `papers/serving_stack_physics/figures/`, each traceable to the stats JSON and reproducible from its generator. Caption text is paper-ready; adapt as needed.
